	...
	<div class="container">
		...
		<form:form action="/registro" method="post" modelAttribute="usuario">
			...
			<form:select path="genero" class="form-select">
				...
				<form:option value="3">Prefiero no Decir</form:option>
			</form:select>
			<!--
			<form:radiobutton path="genero" value="1"/>Femenino<br>
			<form:radiobutton path="genero" value="2"/>Masculino<br>
			<form:radiobutton path="genero" value="3"/>Prefiero no decir<br>
			-->
